  ...
  return (
    <div>
      <form className="flex flex-col" onSubmit={onSubmit}>
        <div>
          <Label className="flex items-center justify-between" htmlFor="welcomeMessage">
        ...
        {mode === "edit" && (
          <button className="mt-1 bg-accent text-accent-fg px-4 py-[2px] rounded-md focus:ring-accent focus:ring-1 focus:ring-offset-2 focus:ring-offset-bg self-end">Save</button>
        )}
      </form>
    </div>
  )
