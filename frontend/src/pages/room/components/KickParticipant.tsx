          ...
          <form onSubmit={onSubmit}>
            <div className="flex gap-4">
              <div className="flex flex-col gap-2 flex-2">
                ...
                <input onChange={() => {
                  setError("")
                }} ref={inputRef} id="duration" type="number" className="w-full border border-border bg-transparent rounded-md p-2 px-3" autoComplete="off" placeholder="Enter duration" />
              </div>
              <div className="flex flex-col gap-2 flex-1">
                <Label htmlFor="unit">Unit</Label>
                <Select id="unit" placeholder="Select duration" value={unit} setValue={(unit: any) => {
                  setUnit(unit)
            ...
            <div className="flex items-center gap-4 mt-5">
              <Label htmlFor="clearChat" className="text-muted">Clear Chat</Label>
              <Switch id="clearChat" setChecked={setClearChat} checked={clearChat} />
            </div>
            ...
            <div className="justify-end flex justify-end gap-3 items-center mt-8">
              ...
              <button type="submit" className="bg-accent text-accent-fg px-4 py-1 rounded-md focus:ring-accent focus:ring-1 focus:ring-offset-2 focus:ring-offset-bg disabled:opacity-70 flex gap-2 items-center">
                Kick
              </button>
            </div>
          </form>
