	...
	return (
		...
		>
			<Dialog.Portal>
				...
				<Dialog.Content className="border border-border w-[90vw] max-w-[550px] rounded-lg fixed top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] p-8 shadow-md focus:outline-none bg-bg-2">
					...
					<div className="flex justify-end gap-5 items-center">
						<button
							className="bg-bg-3 text-fg-3 px-4 py-1 rounded"
							onClick={() => {
